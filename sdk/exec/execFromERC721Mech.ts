...
export const makeExecTransaction = (mechAddress: string, transaction: TransactionRequest): TransactionRequest => {
  ...
  return {
    ...transaction,
    to: mechAddress,
    data: IMech.encodeFunctionData("exec", [transaction.to || '', transaction.value || 0, transaction.data || '0x', 0, txGas]),
